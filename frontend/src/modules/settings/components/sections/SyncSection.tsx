...
export function SyncSection({ isConnected, isGoogleAuthLoading, onGoogleAction }: SyncSectionProps) {
	return (
		<SettingsSection title="Синхронизация" contentClassName="px-[6px] py-3">
			<SettingsInfoRow
